...
if cmd == "toggle mgoc" and hosts[name] and SETUP.challengemode=="build" then tfm.exec.newGame('<C><P H="850" F="8" L="3000" mgoc="-888" bh=""/><Z><S><S H="50" P="0,0,0.3,0.2,0,0,0,0" L="3200" X="1500" Y="825" T="6" lua="-888"/></S><D /><O /></Z></C>')
...
function eventTextAreaCallback(textAreaID, playerName, callback)
	...
	if callback=="clsconf" then
		trainingcore(playerName,"panel:closeexitmenu")
