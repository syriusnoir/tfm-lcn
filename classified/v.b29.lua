...
SETUP = {flymode = false,challengemode = "survival",autorespawn = "false"}
--                                          ^^ izmaini šajā spraugā uz survival (ja izdzīvošanas challenge), vanilla (ja beznaglu) vai build (ja būvdarbu)

-- survival palaiž ar !c survival, pēc tam dari !nextmap līdz fināla raundam, kur tad ar !bc vai !utilcore paziņo uzvarētāju(s)
...
player={}
hosts={['Host1#????'] = true} --  ,['Ertyezz#9819'] = true,['Laimesberns#3746'] = true -- izmaini uz savu vārdu
contestants={['Player1#????'] = true,['Player2#????'] = true,['Player3#????'] = true,['Player4#????'] = true} -- izmaini vārdus uz dalībnieku vārdiem (savu vardu nevajag)
