...
contestants={['Xeon#1182'] = true,['Sanija#1187'] = true,['Zurcinaa#0000'] = true,['Ilutaffie#9665'] = true,['Ertyezz#9819'] = true,['Miks#7922'] = true,['Nixieoffset#1925'] = true}
...
tfm.exec.bindKeyboard(hosts,18,true,true)
tfm.exec.bindKeyboard(hosts,33,true,true)
tfm.exec.bindKeyboard(hosts,34,true,true)
end
...
survrounds = 0 
survrot = {7479177,7482494,7485763,map1,map2,map4,map702,map703,map704}
finalrot = {fap1}
