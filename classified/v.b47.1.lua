...
SETUP = {autoplay = true,challengemode = "survival",autorespawn = false,lang="lv"}
...
function eventPopupAnswer(popupID, name, answer)
	...
	if popupID==800 and hosts[name] then if contestants[answer] then d(answer,0.4,0x000022,5,25) end end
end
