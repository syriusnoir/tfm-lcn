...
SETUP = {debug=true,autoplay = false,challengemode = "build",autorespawn = false,lang="en",theme="classic"}
...
theme = {modern = {windowHeadingColor = "vi",windowBorderColor = 0x000022,startScreenColor = 000022,bcBackground = 0x000022,bcTransparency = 0.65,bcHeight = 22,bcFontSize = 14,bcWidth = 790,bcX = 5},classic = {windowHeadingColor = "rose",windowBorderColor = 0x000000,startScreenColor = 000000,bcBackground = 0x324650,bcTransparency = 0.5,bcHeight = 30,bcFontSize = 20,bcWidth = 600,bcX = 100}}
...
function startMap() tfm.exec.newGame('<C><P DS="m;200,170" APS="169df582e29.png,0,0,0,0,100,50,40" /><Z><S><S P="0,0,0.3,0.2,0,0,0,0" X="0" L="3000" o="'..theme[SETUP.theme].startScreenColor..'" H="3000" c="4" Y="0" T="12" /><S P="0,0,0.3,0.2,0,0,0,0" L="40" o="'..theme[SETUP.theme].startScreenColor..'" H="10" X="200" Y="240" T="12" /><S P="0,0,0.3,0.2,90,0,0,0" L="40" o="'..theme[SETUP.theme].startScreenColor..'" H="10" X="215" Y="225" T="12" /><S P="0,0,0.3,0.2,90,0,0,0" L="40" o="000022" H="10" X="2500" Y="225" T="12" /><S P="0,0,0.3,0.2,90,0,0,0" L="40" o="'..theme[SETUP.theme].startScreenColor..'" H="10" X="185" Y="225" T="12" /><S P="0,0,0.3,0.2,0,0,0,0" L="40" o="'..theme[SETUP.theme].startScreenColor..'" H="10" X="200" Y="210" T="12" /></S><D><DS Y="225" X="200" /></D><O /></Z></C>') 
end
startMap()
...
-- HostCore izsaucējs
validcmds = {contestants={["pr"]=true,["i"]=true,["spawn"]=true},helpers={["bc"]=true,["ce"]=true,["ce*"]=true,["clear"]=true,["i"]=true,["hc"]=true,["r"]=true,["r"]=true,["s"]=true,["s*"]=true,["size"]=true,["smode"]=true},hosts={["bc*"]=true,["end"]=true,["end*"]=true,["kill"]=true,["test"]=true,["sname"]=true,["meep"]=true,["uc"]=true,["uc*"]=true,["hc*"]=true,["next"]=true,["c"]=true,["spawn*"]=true,["r*"]=true,["md"]=true,["md*"]=true,["np"]=true,["np*"]=true,["g"]=true,["g*"]=true,["barrier"]=true,["col"]=true,["sp"]=true,["score"]=true,["add"]=true,["link"]=true,["link*"]=true,["tfm"]=true,["defcol"]=true,["startfrom"]=true,["tfm*"]=true,["d"]=true,["d*"]=true,["cd"]=true,["map"]=true,["defcol"]=true,["tr"]=true,["debug"]=true,["role"]=true,["p"]=true,["play"]=true,["msg"]=true}}
...
if contestants[name] then
    ...
    if c[1] == "i" then
			ui.addTextArea(8999, "<font size='16'><grbl><a href='event:user.cls'>X</a></font> <"..theme[SETUP.theme].windowHeadingColor.."><b>"..trans[203].."</b></"..theme[SETUP.theme].windowHeadingColor.."></font></font>\n___________________________\n\n<font size='14'><bv>"..trans[204].."</bv></font>\n<font size='12'><v><li><a href='event:user.nogui'>"..trans[205].."</a></li><li><a href='event:user.highcontrast'>"..trans[274].."</a></li>", name, 300, 100, 200, 200, 0x000022, 0x00022, 0.65, true)
    end
    if c[1] == "pr" and contestants[c[2]] then
      ui.addTextArea(288, "<font size='16'><grbl><a href='event:pr.cls'>X</a></font> <"..theme[SETUP.theme].windowHeadingColor.."><b>"..tostring(c[2]).."</b></"..theme[SETUP.theme].windowHeadingColor.."></font></font>\n___________________________\n\n<BV>"..tostring(trans[263]).."</BV> <CS>"..tostring(userData[c[2]].lang).."</CS>\n<BV>"..tostring(trans[262]).."</BV> <CS>"..tostring(userData[c[2]].role).."</CS>\n<BV>ID:</BV> <CS>"..tostring(userData[c[2]].id).."</CS>\n<BV>"..tostring(trans[271]).."</BV> <CS>"..tostring(userData[c[2]].tfm).."</CS>", name, 300, 110, 200, 180, 0x000022, 0x000022, 0.6, true)
    end
end
