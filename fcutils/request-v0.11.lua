...
function eventChatCommand(name,cmd)
	...
	if c[1]=="host" and userData[name].host then userData[c[2]].host=true	hostMessage("<FCC><b>• [Module]</b> "..formatName(c[2]).." now has room host rights.") end
