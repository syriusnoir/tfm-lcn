...
if players[name].timestamp < os.time()-(math.random(limit[1],limit[2]) or 1000) then
...
if name == tfm.get.room.owner and c[1]=="despawn" then despawnVal = c[2] end
...
if name == tfm.get.room.owner and c[1]=="limit" then if c[3] then limit[1]=c[2] limit[2]=c[3] else limit[1]=c[2] limit[2]=c[2] end end
end
...
if cannon[1] <= os.time()-despawnVal then
