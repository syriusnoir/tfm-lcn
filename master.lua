...
function newmap()
statemap = threerot[math.random(#threerot)]
tfm.exec.newGame(statemap)

if ertyezzmaps30[statemap] then ui.setmapName("<J>Ertyezz#9819")
elseif sanijamaps30[statemap] then ui.setmapName("<J>Sanija#1187")
elseif syriusmaps30[statemap] then ui.setmapName("<J>Syrius#8114") end
end
