...
SETUP = {debug=true,challengemode="build",autoplay = false,autorespawn = false,lang="en"} 
...
if SETUP == nil then SETUP = {challengemode = "@",lang = "lv"} errstp() end if SETUP.challengemode == nil or type(SETUP.challengemode) == "boolean" then SETUP.challengemode = "@" errstp() end if SETUP.lang == "lv" or SETUP.lang == "en"  or SETUP.lang == "de" then else SETUP.lang = "lv" errstp() end 

title = "#LaChallengeNostra "..SETUP.challengemode
player={} helpers={} disq={} spectators={} restrict={}
hosts={['Syrius#8114'] = true,['Yeet#7143'] = true,['Awesomz#2736'] = true}
contestants={}
...
function startMap() tfm.exec.newGame('<C><P DS="m;200,170" APS="16f09800dd9.png,0,0,0,0,100,50,40" /><Z><S><S P="0,0,0.3,0.2,0,0,0,0" X="0" L="3000" o="'..theme[SETUP.theme].startScreenColor..'" H="3000" c="4" Y="0" T="'..theme[SETUP.theme].startScreenGround..'" /><S P="0,0,0.3,0.2,0,0,0,0" L="40" o="'..theme[SETUP.theme].startScreenColor..'" H="10" X="200" Y="240" T="12" /><S P="0,0,0.3,0.2,90,0,0,0" L="40" o="'..theme[SETUP.theme].startScreenColor..'" H="10" X="215" Y="225" T="12" /><S P="0,0,0.3,0.2,90,0,0,0" L="40" o="000022" H="10" X="2500" Y="225" T="12" /><S P="0,0,0.3,0.2,90,0,0,0" L="40" o="'..theme[SETUP.theme].startScreenColor..'" H="10" X="185" Y="225" T="12" /><S P="0,0,0.3,0.2,0,0,0,0" L="40" o="'..theme[SETUP.theme].startScreenColor..'" H="10" X="200" Y="210" T="12" /></S><D><DS Y="225" X="200" /></D><O /></Z></C>') 
end
startMap()
...
validcmds = {contestants={["pr"]=true,["i"]=true,["spawn"]=true},helpers={["bc"]=true,["f"]=true,["f*"]=true,["ce"]=true,["ce*"]=true,["clear"]=true,["i"]=true,["hc"]=true,["r"]=true,["r"]=true,["s"]=true,["s*"]=true,["size"]=true,["smode"]=true},hosts={["bc*"]=true,["end"]=true,["end*"]=true,["kill"]=true,["test"]=true,["sname"]=true,["meep"]=true,["uc"]=true,["uc*"]=true,["next"]=true,["c"]=true,["spawn*"]=true,["r*"]=true,["md"]=true,["md*"]=true,["np"]=true,["np*"]=true,["g"]=true,["g*"]=true,["barrier"]=true,["col"]=true,["sp"]=true,["score"]=true,["add"]=true,["link"]=true,["link*"]=true,["tfm"]=true,["defcol"]=true,["startfrom"]=true,["tfm*"]=true,["d"]=true,["d*"]=true,["cd"]=true,["map"]=true,["defcol"]=true,["tr"]=true,["debug"]=true,["role"]=true,["p"]=true,["play"]=true,["msg"]=true,["txt"]=true,["settp"]=true,["replace"]=true}}
...
if helpers[name] or hosts[name] then
	if c[1] == "hc" then
		if c[2] ~="-b" and c[2] ~="-e" then hostcore(name) userData[name].hc = true end
		if c[2] ~= "-t" and c[2] ~= "-b" and c[2] ~= "-e" then annonce2(infpref..trans[206].." <grbl>"..name.."</grbl></lbrp>     <N2><font size='10'>"..trans[207].."</font><N2>") end
		...
		if c[2] == "-b" and hosts[name] and userData[name].hc == true then if userData[name].showactionbuffer == false then ui.addTextArea(52, tclog, name, 5, 64, 0, 0, 0x324650, 0x000000, 0, true) ui.removeTextArea(50,name) ui.removeTextArea(51,name) ui.removeTextArea(53,name) userData[name].showactionbuffer = true userData[name].showerrorbuffer = false elseif userData[name].showactionbuffer == true then ui.removeTextArea(52,name) exectrcore(name) userData[name].showactionbuffer = false end end
		if c[2] == "-e" and hosts[name] and userData[name].hc == true then if userData[name].showerrorbuffer == false then ui.addTextArea(53, errlog, name, 5, 64, 0, 0, 0x324650, 0x000000, 0, true) ui.removeTextArea(52,name) userData[name].showactionbuffer = false userData[name].showerrorbuffer = true elseif userData[name].showerrorbuffer == true then ui.removeTextArea(53,name) userData[name].showerrorbuffer = false end end
	end
   if c[1] == "s*" then
   	if c[2] == "all" then
