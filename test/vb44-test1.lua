...
version = "v.b44 <font size='10'><D>test 1</D></font>"
...
function eventColorPicked(id,name,color)
	if id==300 then -- vārda krāsošana
		tfm.exec.setNameColor(colqueue,color)
	end
