...
SETUP = {debug=true,challengemode="build",title="lacrosnostra",autorespawn = false,lang="lv",theme="modern"} 
...
fielddata={header,field1,field2,field3,actions,score}
-- Komandas
...
if hosts[name] then
    ...
    if c[1] == "action" and hosts[name] then 
			if c[2]:sub(1,12)=="superpowers:" then 
				if userData[c[3]].allowedSuperpowers[c[2]:sub(13)]==false then userData[c[3]].allowedSuperpowers[c[2]:sub(13)]=true annonce2(infpref..name.." "..trans[297].." "..c[2]..".") else userData[c[3]].allowedSuperpowers[c[2]:sub(13)]=false annonce2(infpref..name.." "..trans[298].." "..c[2]..".") end
			else error0x6(name)
			end
    end
...
deb(nil,"debdata","<V><b>[eventKeyboard]</b></V> <BL>"..tostring(n).." "..tostring(key).." "..tostring(down).." "..tostring(x).." "..tostring(y))
deb(nil,"debdisplay")
end
