...
SETUP = {challengemode="build",title="lacrosnostra",autorespawn = false,lang="en"} 
...
validcmds = {
	...
	helpers={["bc"]=true,["meep"]=true,["f"]=true,["f*"]=true,["n"]=true,["n*"]=true,["ce"]=true,["ce*"]=true,["clear"]=true,["i"]=true,["hc"]=true,["notepad"]=true,["r"]=true,["r"]=true,["s"]=true,["s*"]=true,["size"]=true,["smode"]=true},
