...
function eventTextAreaCallback(textAreaID, playerName, callback)
	...
	if callback=="init_hostcore" and hosts[playerName] then
		initHostcore(playerName)
		print(syspref.." "..trans[206].." (<V>"..playerName.."</V>)")
		ui.updateTextArea(65,syspref.." "..trans[206].." (<V>"..playerName.."</V>)",nil)
 	...
 	if callback=="ptag" then
		local Ptag = string.match(tfm.get.room.xmlMapInfo.xml, "<P (.-)/>") or ""
		if holding.ctrl[playerName] then
		...
		elseif holding.shift[playerName] or #Ptag>120 then
	...
	if callback=="printtemp" then
		...
		if SETUP.challengemode=="pkg" then print(syspref.." "..trans[84].." - https://atelier801.com/topic?f=774444&t=930558&p=1#m1") print(syspref.." "..trans[85].." - https://atelier801.com/topic?f=774444&t=932134&p=1#m1")
