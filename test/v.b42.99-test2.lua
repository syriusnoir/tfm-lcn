...
SETUP = {flymode = false,challengemode = "build",autorespawn = false,everyoneVerified="true"}

-- [[LaChallengeNostra: LV, EN, DE]]
 
version = "v.b42.99 <font size='10'><D>test 2</D></font>"
