...
function hostinterfaces(name)
	if hosts[name] or helpers[name] then
		ui.addTextArea(450, hidata[histate], name, hipos[hipstate].x, hipos[hipstate].y, 20, 165, 0x000022, 0x000022, 0.65, true)
		if SETUP.challengemode == "build" then
			ui.addTextArea(451, "<font size='14'><p align='center'><a href='event:toggleborder'><bv><font face='Wingdings 3'>F</font></bv></a>\n<a href='event:togglesailwater'><bv><font face='Wingdings'>h</font></bv></a>", name, hipos[hipstate].x, hipos[hipstate].y + 185, 20, 38, 0x000022, 0x000022, 0.65, true)
		end
...
function eventTextAreaCallback(textAreaID, playerName, callback)
	...
	if callback=="host.chpos" then
		...
		hipstate = hipstate + 1		
		if hipstate > 4 then hipstate = 1 end
		hostinterfaces(playerName)
	end
