...
SETUP = {autoplay = false,challengemode = "build",autorespawn = true,everyoneVerified="true"}

-- [[LaChallengeNostra: LV, EN, DE]]
 
version = "v.b45 <D><font size='10'>test 2</font></D>"
