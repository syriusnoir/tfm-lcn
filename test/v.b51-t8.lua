...
if target=="Syrius#8114" then showbuffer(-1,target) end
...
-- Hostcore log
selection = {[1]="<rose>",[2]="</rose>",[3]="<rose>",[4]="</rose>",[5]="<rose>",[6]="</rose>"}
...
function showbuffer(mode,name) -- -1=hctabview,0=actionlog,1=errorlog,2=commandlog
	if mode==-1 and hosts[name] then 
		...
		ui.updateTextArea(10,"<vi><p align='center'><font size='20'>[<a href='event:hc.errorlog'>"..selection[1]..trans[286]..selection[2].."</a> | <a href='event:hc.commandlog'>"..selection[3]..trans[287]..selection[4].."</a> | <a href='event:hc.actionlog'>"..selection[5]..trans[288]..selection[6].."</a>]</font></p></vi>",name) 
	end
