...
function iter(evtCC,evtPA)
	...
	annonce2(infpref..evtCC[4].." "..string.format(trans[308],evtPA[3],counter))
end
...
function eventColorPicked(id,name,color)
	...
	if id==305 then -- spēles fona krāsošana
		...
		annonce2(infpref..name.." "..trans[313].." <font face='Lucida Console'><font color='#"..readable.."'>■</font>"..readable.."</font>.")
	end
end
