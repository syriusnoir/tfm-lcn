...
-- Augsta līmeņa komandas
    ...
    if c[1] == "sp" and hosts[name] then
			...
			ui.updateTextArea(0,"<CE>"..trans[251].." "..trans[221]..":<CS> "..trans[211],c[2])
    elseif c[1] == "sp" then
        error0x1(name)
    end
...
survrounds = 0 
--##########################$201###$202####$703#####$701#####$203
survrot = {7479177,7482494,7602083,7602098,7605138,7605136,7622015}
finalrot = {fap1}
