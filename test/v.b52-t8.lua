...
if hosts[name] then
    ...
    if c[1] == "action" and hosts[name] then 
			if c[2]:sub(1,12)=="superpowers:" then 
				if userData[c[3]].allowedSuperpowers[c[2]:sub(13)]==false then userData[c[3]].allowedSuperpowers[c[2]:sub(13)]=true else userData[c[3]].allowedSuperpowers[c[2]:sub(13)]=false end
			end
    end
...
function eventTextAreaCallback(textAreaID, playerName, callback)
	...
	if callback=="removefieldui" then
		trainingcore(playerName,"panel:toggleborder")
		buildborder()
	end
