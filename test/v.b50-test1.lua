...
if cmd == "c build" and SETUP.challengemode == "build" and hosts[name] then hostinterfaces(name)
...
-- Augsta līmeņa komandas
   ...
   elseif c[1] == "startfrom" then
    ...
    if c[1] == "map" and hosts[name] then
			...
			for i=0,math.ceil(c[3]/3000) do
				tfm.exec.addPhysicObject(-888 - i,1500 + (i * 3000),c[4] - 25,{type=c[6],width=3000,height=50,restitution=0.2,friction=0.3,})
			end
