...
SETUP = {debug=true,autoplay = false,challengemode = "build",autorespawn = false,lang="en"}
...
-- HostCore izsaucējs
validcmds = {contestants={["pr"]=true,["i"]=true,["spawn"]=true},helpers={["bc"]=true,["f"]=true,["f*"]=true,["ce"]=true,["ce*"]=true,["clear"]=true,["i"]=true,["hc"]=true,["r"]=true,["r"]=true,["s"]=true,["s*"]=true,["size"]=true,["smode"]=true},hosts={["bc*"]=true,["end"]=true,["end*"]=true,["kill"]=true,["test"]=true,["sname"]=true,["meep"]=true,["uc"]=true,["uc*"]=true,["hc*"]=true,["next"]=true,["c"]=true,["spawn*"]=true,["r*"]=true,["md"]=true,["md*"]=true,["np"]=true,["np*"]=true,["g"]=true,["g*"]=true,["barrier"]=true,["col"]=true,["sp"]=true,["score"]=true,["add"]=true,["link"]=true,["link*"]=true,["tfm"]=true,["defcol"]=true,["startfrom"]=true,["tfm*"]=true,["d"]=true,["d*"]=true,["cd"]=true,["map"]=true,["defcol"]=true,["tr"]=true,["debug"]=true,["role"]=true,["p"]=true,["play"]=true,["msg"]=true,["txt"]=true,["settp"]=true}}
...
if hosts[name] then
    ...
    if c[1] == "txt" and hosts[name] then
		if type(tonumber(c[2])) == "number" then c[2] = 470000 + tonumber(c[2]) else c[2] = 470000 end
		ui.addTextArea(c[2],string.gsub(string.gsub(string.gsub(tostring(c[6]), "&gt;", ">"), "&lt;", "<"), "|", " "),nil,c[3],c[4],0,0,"0x"..c[5],"0x"..c[5],0.65,false)
    end
