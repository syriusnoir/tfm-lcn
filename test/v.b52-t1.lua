...
SETUP = {challengemode="build",title="lacrosnostra",autorespawn = false,lang="lv",theme="classic"} 
...
theme = {modern = {hcHeight = 30,windowHeadingColor = "vi",windowBorderColor = 0x000022,windowColor = 0x000022,highlightedWindowColor = 0x000044,contestSelWindowColor = 0x000033,contestSelWindowBorder = 0x000066,contestSelWindowTransparency = 1,windowColor2 = 0x000022,closeBtnColor = "grbl",startScreenColor = 000022,startScreenGround = 12,bcBackground = 0x000022,bcTransparency = 0.65,bcHeight = 22,bcFontSize = 14,bcWidth = 790,bcX = 5,welcomeScreenColor = 0x000022,commonColor1 = "grbl",commonColor2 = "brp",commonColor3 = "lbrp",commonColor4 = "vi",commonColor5 = "rose"},classic = {hcHeight = 30,windowHeadingColor = "rose",windowBorderColor = 0x000000,windowColor = 0x324650,windowColor2 = 0x000001,highlightedWindowColor = 0x324650,contestSelWindowColor = 0x324650,contestSelWindowBorder = 0x000000,contestSelWindowTransparency = 0.5,closeBtnColor = "warn",startScreenColor = 000000,startScreenGround = 12,bcBackground = 0x324650,bcTransparency = 0.5,bcHeight = 30,bcFontSize = 20,bcWidth = 600,bcX = 100,welcomeScreenColor = 0x000001,commonColor1 = "grbl",commonColor2 = "PT",commonColor3 = "T",commonColor4 = "PS",commonColor5 = "S"}}
