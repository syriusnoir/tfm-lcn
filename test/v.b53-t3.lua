...
validcmds = {
	...
	helpers={["bc"]=true,["meep"]=true,["f"]=true,["f*"]=true,["n"]=true,["n*"]=true,["ce"]=true,["ce*"]=true,["clear"]=true,["i"]=true,["hc"]=true,["notepad"]=true,["r"]=true,["r"]=true,["s"]=true,["s*"]=true,["size"]=true,["smode"]=true,["change"]=true},
	hosts={["bc*"]=true,["end"]=true,["end*"]=true,["kill"]=true,["test"]=true,["sname"]=true,["uc"]=true,["uc*"]=true,["next"]=true,["c"]=true,["spawn*"]=true,["r*"]=true,["md"]=true,["md*"]=true,["np"]=true,["np*"]=true,["g"]=true,["g*"]=true,["barrier"]=true,["col"]=true,["sp"]=true,["score"]=true,["add"]=true,["link"]=true,["link*"]=true,["tfm"]=true,["defcol"]=true,["startfrom"]=true,["tfm*"]=true,["d"]=true,["d*"]=true,["cd"]=true,["map"]=true,["defcol"]=true,["tr"]=true,["debug"]=true,["role"]=true,["p"]=true,["f1"]=true,["f2"]=true,["f3"]=true,["fa"]=true,["fs"]=true,["fieldui"]=true,["fh"]=true,["play"]=true,["msg"]=true,["txt"]=true,["settp"]=true,["action"]=true,["mp"]=true,["set"]=true,["setfreq"]=true}
}
...
if hosts[name] then
    ...
    if c[1] == "map" and hosts[name] then
			...
			for i=1,#c do
				if c[i]=="-a" then print("<VI>"..i) allObjectsUnlocked = true c[i]=nil end
			end
			c[2] = c[2] or 0 --mgoc
			...
			if allObjectsUnlocked then
				...
				inheritobjects = 'shaman_tools="'..table.concat(objtable,",")..'"'; print("<VI>inheritobjects")
			else 
				inheritobjects = ""; print("<R>inheritobjects")
			end
